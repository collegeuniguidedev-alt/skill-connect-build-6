...
function CompanyPage() {
  ...
  return (
    <AppShell persona="company" showSubNav={false}>
      <div className="space-y-10">
        ...
        <div className="grid gap-4 md:grid-cols-4">
          <Stat label="Programs" value={companyPrograms.length} tone="text-sky-700" />
          <Stat label="Enrollments" value={enrolls.length} tone="text-sky-700" />
          <Stat label="Completion rate" value={`${completionRate}%`} tone="text-sky-700" />
          <Stat label="Applications" value={apps} tone="text-sky-700" />
        </div>

        <div className="grid gap-8 md:grid-cols-2">
          <section>
            <h2 className="mb-3 text-lg font-semibold">Your programs</h2>
